		...
		if ($this->avatars_enabled_full && $avatars_path)
		{
			...
			else if ($wow_r !== null)
			{
				...
				*/
				...
				{
					case 1: // Human
						$valid = (in_array($wow_c, array(1, 2, 3, 4, 5, 7, 8, 9, 10))) ? true : false;
						$avail = (in_array($wow_c, array(1, 2, 4, 5, 7, 8, 9))) ? true : false;
						$faction = 1;
						break;

					case 2: // Orc
						$valid = (in_array($wow_c, array(1, 2, 3, 6, 7, 8, 9, 10))) ? true : false;
						$avail = (in_array($wow_c, array(1, 2, 3, 6, 7, 9))) ? true : false;
						$faction = 2;
						break;
