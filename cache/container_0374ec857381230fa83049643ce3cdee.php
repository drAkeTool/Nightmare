...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'dmzx.loadingindicator.listener' => 'getDmzx_Loadingindicator_ListenerService',
            ...
            'forumhulp.uploadimage.admin.controller' => 'getForumhulp_Uploadimage_Admin_ControllerService',
            ...
            'log' => 'getLogService',
            'marc.quickedit.listener' => 'getMarc_Quickedit_ListenerService',
            'marc.quickedit.listener_helper' => 'getMarc_Quickedit_ListenerHelperService',
            ...
            'paybas.breadcrumbmenu.listener' => 'getPaybas_Breadcrumbmenu_ListenerService',
            'paybas.pbwow.core' => 'getPaybas_Pbwow_CoreService',
            'paybas.pbwow.listener' => 'getPaybas_Pbwow_ListenerService',
            'paybas.rankpoststyling.listener' => 'getPaybas_Rankpoststyling_ListenerService',
            'php_ini' => 'getPhpIniService',
            'phpbb.pages.admin.controller' => 'getPhpbb_Pages_Admin_ControllerService',
            'phpbb.pages.controller' => 'getPhpbb_Pages_ControllerService',
            'phpbb.pages.entity' => 'getPhpbb_Pages_EntityService',
            'phpbb.pages.listener' => 'getPhpbb_Pages_ListenerService',
            'phpbb.pages.operator' => 'getPhpbb_Pages_OperatorService',
            'pico.reputation.acp.controller' => 'getPico_Reputation_Acp_ControllerService',
            'pico.reputation.acp_listener' => 'getPico_Reputation_AcpListenerService',
            'pico.reputation.action.controller' => 'getPico_Reputation_Action_ControllerService',
            'pico.reputation.details.controller' => 'getPico_Reputation_Details_ControllerService',
            'pico.reputation.helper' => 'getPico_Reputation_HelperService',
            'pico.reputation.index_listener' => 'getPico_Reputation_IndexListenerService',
            'pico.reputation.main_listener' => 'getPico_Reputation_MainListenerService',
            'pico.reputation.manager' => 'getPico_Reputation_ManagerService',
            'pico.reputation.mcp_listener' => 'getPico_Reputation_McpListenerService',
            'pico.reputation.memberlist_listener' => 'getPico_Reputation_MemberlistListenerService',
            'pico.reputation.notification.type.rate_post_negative' => 'getPico_Reputation_Notification_Type_RatePostNegativeService',
            'pico.reputation.notification.type.rate_post_positive' => 'getPico_Reputation_Notification_Type_RatePostPositiveService',
            'pico.reputation.notification.type.rate_user' => 'getPico_Reputation_Notification_Type_RateUserService',
            'pico.reputation.power' => 'getPico_Reputation_PowerService',
            'pico.reputation.rating.controller' => 'getPico_Reputation_Rating_ControllerService',
            'pico.reputation.viewtopic_listener' => 'getPico_Reputation_ViewtopicListenerService',
            ...
            'zoddo.postmodels.controller' => 'getZoddo_Postmodels_ControllerService',
            'zoddo.postmodels.listener' => 'getZoddo_Postmodels_ListenerService',
        );
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('', 'lmacias_drakness', 'drakness666', 'lmacias_esparcraft', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('dmzx.loadingindicator.listener', 'dmzx\\loadingindicator\\event\\listener');
        $instance->addSubscriberService('marc.quickedit.listener', 'marc\\quickedit\\event\\listener');
        $instance->addSubscriberService('paybas.breadcrumbmenu.listener', 'paybas\\breadcrumbmenu\\event\\listener');
        $instance->addSubscriberService('paybas.pbwow.listener', 'paybas\\pbwow\\event\\listener');
        $instance->addSubscriberService('paybas.rankpoststyling.listener', 'paybas\\rankpoststyling\\event\\listener');
        $instance->addSubscriberService('phpbb.pages.listener', 'phpbb\\pages\\event\\listener');
        $instance->addSubscriberService('pico.reputation.acp_listener', 'pico\\reputation\\event\\acp_listener');
        $instance->addSubscriberService('pico.reputation.index_listener', 'pico\\reputation\\event\\index_listener');
        $instance->addSubscriberService('pico.reputation.main_listener', 'pico\\reputation\\event\\main_listener');
        $instance->addSubscriberService('pico.reputation.mcp_listener', 'pico\\reputation\\event\\mcp_listener');
        $instance->addSubscriberService('pico.reputation.memberlist_listener', 'pico\\reputation\\event\\memberlist_listener');
        $instance->addSubscriberService('pico.reputation.viewtopic_listener', 'pico\\reputation\\event\\viewtopic_listener');
        ...
        $instance->addSubscriberService('zoddo.postmodels.listener', 'zoddo\\postmodels\\event\\listener');
    ...
    /**
     * Gets the 'dmzx.loadingindicator.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\loadingindicator\event\listener A dmzx\loadingindicator\event\listener instance.
     */
    protected function getDmzx_Loadingindicator_ListenerService()
    {
        return $this->services['dmzx.loadingindicator.listener'] = new \dmzx\loadingindicator\event\listener();
    }
    ...
    /**
     * Gets the 'forumhulp.uploadimage.admin.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \forumhulp\uploadimage\controller\admin_controller A forumhulp\uploadimage\controller\admin_controller instance.
     */
    protected function getForumhulp_Uploadimage_Admin_ControllerService()
    {
        return $this->services['forumhulp.uploadimage.admin.controller'] = new \forumhulp\uploadimage\controller\admin_controller($this->get('config'), $this->get('request'), $this->get('user'), $this, $this->get('template'), $this->get('path_helper'), $this->get('cache'), $this->get('pagination'), $this->get('log'), $this->get('plupload'), './', 'php');
    }
    ...
    /**
     * Gets the 'marc.quickedit.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \marc\quickedit\event\listener A marc\quickedit\event\listener instance.
     */
    protected function getMarc_Quickedit_ListenerService()
    {
        return $this->services['marc.quickedit.listener'] = new \marc\quickedit\event\listener($this->get('config'), $this->get('marc.quickedit.listener_helper'), $this->get('request'), $this->get('template'), $this->get('user'));
    }

    /**
     * Gets the 'marc.quickedit.listener_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \marc\quickedit\event\listener_helper A marc\quickedit\event\listener_helper instance.
     */
    protected function getMarc_Quickedit_ListenerHelperService()
    {
        return $this->services['marc.quickedit.listener_helper'] = new \marc\quickedit\event\listener_helper($this->get('auth'), $this->get('config'), $this->get('request'));
    }
    ...
    protected function getNotification_TypeCollectionService()
    {
        ...
        $instance->add('pico.reputation.notification.type.rate_post_positive');
        $instance->add('pico.reputation.notification.type.rate_post_negative');
        $instance->add('pico.reputation.notification.type.rate_user');
    ...
    /**
     * Gets the 'paybas.breadcrumbmenu.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\breadcrumbmenu\event\listener A paybas\breadcrumbmenu\event\listener instance.
     */
    protected function getPaybas_Breadcrumbmenu_ListenerService()
    {
        return $this->services['paybas.breadcrumbmenu.listener'] = new \paybas\breadcrumbmenu\event\listener($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), './', 'php');
    }
    ...
    /**
     * Gets the 'paybas.rankpoststyling.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\rankpoststyling\event\listener A paybas\rankpoststyling\event\listener instance.
     */
    protected function getPaybas_Rankpoststyling_ListenerService()
    {
        return $this->services['paybas.rankpoststyling.listener'] = new \paybas\rankpoststyling\event\listener($this->get('cache'), $this->get('request'), $this->get('user'));
    }
    ...
    /**
     * Gets the 'phpbb.pages.admin.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\pages\controller\admin_controller A phpbb\pages\controller\admin_controller instance.
     */
    protected function getPhpbb_Pages_Admin_ControllerService()
    {
        return $this->services['phpbb.pages.admin.controller'] = new \phpbb\pages\controller\admin_controller($this->get('controller.helper'), $this->get('log'), $this->get('phpbb.pages.operator'), $this->get('request'), $this->get('template'), $this->get('user'), $this, $this->get('dispatcher'), './', 'php');
    }

    /**
     * Gets the 'phpbb.pages.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\pages\controller\main_controller A phpbb\pages\controller\main_controller instance.
     */
    protected function getPhpbb_Pages_ControllerService()
    {
        return $this->services['phpbb.pages.controller'] = new \phpbb\pages\controller\main_controller($this->get('auth'), $this, $this->get('controller.helper'), $this->get('template'), $this->get('user'));
    }

    /**
     * Gets the 'phpbb.pages.entity' service.
     *
     * @return \phpbb\pages\entity\page A phpbb\pages\entity\page instance.
     */
    protected function getPhpbb_Pages_EntityService()
    {
        return new \phpbb\pages\entity\page($this->get('dbal.conn'), $this->get('config'), $this->get('dispatcher'), 'phpbb_pages', NULL);
    }

    /**
     * Gets the 'phpbb.pages.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\pages\event\listener A phpbb\pages\event\listener instance.
     */
    protected function getPhpbb_Pages_ListenerService()
    {
        return $this->services['phpbb.pages.listener'] = new \phpbb\pages\event\listener($this->get('auth'), $this->get('controller.helper'), $this->get('phpbb.pages.operator'), $this->get('template'), $this->get('user'), './', 'php');
    }

    /**
     * Gets the 'phpbb.pages.operator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\pages\operators\page A phpbb\pages\operators\page instance.
     */
    protected function getPhpbb_Pages_OperatorService()
    {
        return $this->services['phpbb.pages.operator'] = new \phpbb\pages\operators\page($this->get('cache.driver'), $this, $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbb_pages', 'phpbb_pages_links', 'phpbb_pages_pages_links');
    }

    /**
     * Gets the 'pico.reputation.acp.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\controller\acp_controller A pico\reputation\controller\acp_controller instance.
     */
    protected function getPico_Reputation_Acp_ControllerService()
    {
        return $this->services['pico.reputation.acp.controller'] = new \pico\reputation\controller\acp_controller($this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('pico.reputation.manager'), 'phpbb_reputations', './', 'adm/', 'php');
    }

    /**
     * Gets the 'pico.reputation.acp_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\event\acp_listener A pico\reputation\event\acp_listener instance.
     */
    protected function getPico_Reputation_AcpListenerService()
    {
        return $this->services['pico.reputation.acp_listener'] = new \pico\reputation\event\acp_listener($this->get('request'), $this->get('template'));
    }

    /**
     * Gets the 'pico.reputation.action.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\controller\action_controller A pico\reputation\controller\action_controller instance.
     */
    protected function getPico_Reputation_Action_ControllerService()
    {
        return $this->services['pico.reputation.action.controller'] = new \pico\reputation\controller\action_controller($this->get('auth'), $this->get('controller.helper'), $this->get('dbal.conn'), $this->get('request'), $this->get('user'), $this->get('pico.reputation.helper'), $this->get('pico.reputation.manager'), 'phpbb_reputations', 'phpbb_reputation_types', './', 'php');
    }

    /**
     * Gets the 'pico.reputation.details.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\controller\details_controller A pico\reputation\controller\details_controller instance.
     */
    protected function getPico_Reputation_Details_ControllerService()
    {
        return $this->services['pico.reputation.details.controller'] = new \pico\reputation\controller\details_controller($this->get('auth'), $this->get('config'), $this->get('controller.helper'), $this->get('dbal.conn'), $this->get('pagination'), $this->get('request'), $this->get('symfony_request'), $this->get('template'), $this->get('user'), $this->get('pico.reputation.helper'), $this->get('pico.reputation.manager'), $this->get('pico.reputation.power'), 'phpbb_reputations', 'phpbb_reputation_types', './', 'php');
    }

    /**
     * Gets the 'pico.reputation.helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\core\reputation_helper A pico\reputation\core\reputation_helper instance.
     */
    protected function getPico_Reputation_HelperService()
    {
        return $this->services['pico.reputation.helper'] = new \pico\reputation\core\reputation_helper();
    }

    /**
     * Gets the 'pico.reputation.index_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\event\index_listener A pico\reputation\event\index_listener instance.
     */
    protected function getPico_Reputation_IndexListenerService()
    {
        return $this->services['pico.reputation.index_listener'] = new \pico\reputation\event\index_listener($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('controller.helper'), $this->get('template'), $this->get('user'));
    }

    /**
     * Gets the 'pico.reputation.main_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\event\main_listener A pico\reputation\event\main_listener instance.
     */
    protected function getPico_Reputation_MainListenerService()
    {
        return $this->services['pico.reputation.main_listener'] = new \pico\reputation\event\main_listener($this->get('config'), $this->get('template'));
    }

    /**
     * Gets the 'pico.reputation.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\core\reputation_manager A pico\reputation\core\reputation_manager instance.
     */
    protected function getPico_Reputation_ManagerService()
    {
        return $this->services['pico.reputation.manager'] = new \pico\reputation\core\reputation_manager($this->get('auth'), $this->get('cache'), $this->get('config'), $this->get('dbal.conn'), $this->get('log'), $this->get('notification_manager'), $this->get('template'), $this->get('user'), 'phpbb_reputations', 'phpbb_reputation_types', './', 'php');
    }

    /**
     * Gets the 'pico.reputation.mcp_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\event\mcp_listener A pico\reputation\event\mcp_listener instance.
     */
    protected function getPico_Reputation_McpListenerService()
    {
        return $this->services['pico.reputation.mcp_listener'] = new \pico\reputation\event\mcp_listener($this->get('auth'), $this->get('config'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('pico.reputation.manager'));
    }

    /**
     * Gets the 'pico.reputation.memberlist_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\event\memberlist_listener A pico\reputation\event\memberlist_listener instance.
     */
    protected function getPico_Reputation_MemberlistListenerService()
    {
        return $this->services['pico.reputation.memberlist_listener'] = new \pico\reputation\event\memberlist_listener($this->get('auth'), $this->get('config'), $this->get('controller.helper'));
    }

    /**
     * Gets the 'pico.reputation.notification.type.rate_post_negative' service.
     *
     * @return \pico\reputation\notification\type\rate_post_negative A pico\reputation\notification\type\rate_post_negative instance.
     */
    protected function getPico_Reputation_Notification_Type_RatePostNegativeService()
    {
        return new \pico\reputation\notification\type\rate_post_negative($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'pico.reputation.notification.type.rate_post_positive' service.
     *
     * @return \pico\reputation\notification\type\rate_post_positive A pico\reputation\notification\type\rate_post_positive instance.
     */
    protected function getPico_Reputation_Notification_Type_RatePostPositiveService()
    {
        return new \pico\reputation\notification\type\rate_post_positive($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'pico.reputation.notification.type.rate_user' service.
     *
     * @return \pico\reputation\notification\type\rate_user A pico\reputation\notification\type\rate_user instance.
     */
    protected function getPico_Reputation_Notification_Type_RateUserService()
    {
        return new \pico\reputation\notification\type\rate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), $this->get('controller.helper'), './', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'pico.reputation.power' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\core\reputation_power A pico\reputation\core\reputation_power instance.
     */
    protected function getPico_Reputation_PowerService()
    {
        return $this->services['pico.reputation.power'] = new \pico\reputation\core\reputation_power($this->get('config'), $this->get('dbal.conn'), 'phpbb_reputations');
    }

    /**
     * Gets the 'pico.reputation.rating.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\controller\rating_controller A pico\reputation\controller\rating_controller instance.
     */
    protected function getPico_Reputation_Rating_ControllerService()
    {
        return $this->services['pico.reputation.rating.controller'] = new \pico\reputation\controller\rating_controller($this->get('auth'), $this->get('config'), $this->get('controller.helper'), $this->get('dbal.conn'), $this->get('request'), $this->get('symfony_request'), $this->get('template'), $this->get('user'), $this->get('pico.reputation.helper'), $this->get('pico.reputation.manager'), $this->get('pico.reputation.power'), 'phpbb_reputations', './', 'php');
    }

    /**
     * Gets the 'pico.reputation.viewtopic_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\reputation\event\viewtopic_listener A pico\reputation\event\viewtopic_listener instance.
     */
    protected function getPico_Reputation_ViewtopicListenerService()
    {
        return $this->services['pico.reputation.viewtopic_listener'] = new \pico\reputation\event\viewtopic_listener($this->get('auth'), $this->get('config'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), $this->get('pico.reputation.helper'), 'phpbb_reputations');
    }
    ...
    /**
     * Gets the 'rmcgirr83.elonw.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \rmcgirr83\elonw\event\listener A rmcgirr83\elonw\event\listener instance.
     */
    protected function getRmcgirr83_Elonw_ListenerService()
    {
        return $this->services['rmcgirr83.elonw.listener'] = new \rmcgirr83\elonw\event\listener($this->get('config'), $this->get('request'), $this->get('template'), $this->get('user'));
    }
    ...
    /**
     * Gets the 'vse.lightbox.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\lightbox\event\listener A vse\lightbox\event\listener instance.
     */
    protected function getVse_Lightbox_ListenerService()
    {
        return $this->services['vse.lightbox.listener'] = new \vse\lightbox\event\listener($this->get('config'), $this->get('template'), $this->get('user'));
    }
    ...
    /**
     * Gets the 'zoddo.postmodels.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \zoddo\postmodels\controller\main_controller A zoddo\postmodels\controller\main_controller instance.
     */
    protected function getZoddo_Postmodels_ControllerService()
    {
        return $this->services['zoddo.postmodels.controller'] = new \zoddo\postmodels\controller\main_controller($this->get('controller.helper'), $this->get('request'), $this->get('zoddo.postmodels.listener'));
    }

    /**
     * Gets the 'zoddo.postmodels.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \zoddo\postmodels\event\listener A zoddo\postmodels\event\listener instance.
     */
    protected function getZoddo_Postmodels_ListenerService()
    {
        return $this->services['zoddo.postmodels.listener'] = new \zoddo\postmodels\event\listener($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('template'), $this->get('request'), $this->get('controller.helper'), 'phpbb_');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'phpbb.pages.tables.pages' => 'phpbb_pages',
            'phpbb.pages.tables.pages_links' => 'phpbb_pages_links',
            'phpbb.pages.tables.pages_pages_links' => 'phpbb_pages_pages_links',
            'tables.reputations' => 'phpbb_reputations',
            'tables.reputation_types' => 'phpbb_reputation_types',
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbb_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysqli',
            'dbal.dbhost' => '',
            'dbal.dbuser' => 'lmacias_drakness',
            'dbal.dbpasswd' => 'drakness666',
            'dbal.dbname' => 'lmacias_esparcraft',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
